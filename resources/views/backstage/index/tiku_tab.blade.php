    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card bg-success text-white indexlabel">
                <div class="card-body">
                    <h5 class="index_h5"><span class="fa fa-user-plus"></span>&nbsp;&nbsp;试题
                    </h5>
                    <br class="border">
        ...
        <div class="col-md-6">
            <div class="card bg-primary text-white indexlabel">
                <div class="card-body index_card_body">
                    <h5 class="index_h5"><span class="fa fa-user-circle"></span>&nbsp;&nbsp;题型
                    </h5>
                    <br class="border">
        ...
        <div class="col-md-6">
            <div class="card bg-danger text-white indexlabel">
                <div class="card-body">
                    <h5 class="index_h5"><span class="fa fa-file-text-o"></span>&nbsp;&nbsp;专业
                    </h5>
                    <br class="border">
        ...
        <div class="col-md-6">
            <div class="card bg-warning text-white indexlabel">
                <div class="card-body">
                    <h5 class="index_h5"><span class="fa fa-file-text-o"></span>&nbsp;&nbsp;种类
                    </h5>
                    <br class="border">
